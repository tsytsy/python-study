            ...
            if not(index.isdigit()):
                if index == 'q':
                    ...
                    for i in shopping_list:
                        print(i, shopping_list[i][0], count_list[shopping_list[i][0]+"_count"], shopping_list[i][2], count_list[shopping_list[i][0]+"_count"]*shopping_list[i][2])
                ...
                if index > len(price_list):
                    ...
                    if balance < price_list[index-1]:
                        ...
                        if count_list[count_name] == 1:
                            shopping_list[index] = [product_list[index-1], count_list[count_name], price_list[index-1], price_list[index-1]*count_list[count_name]]
